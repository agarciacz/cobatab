        ...
        <section class="col-md-5 col-md-offset-3">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Actualizar datos del padre</h3>
                </div>
                <div class="box-body">
                    @if ($errors->any())
                    ...
                    @endif
                    <form method="post" action=" {{route('form_update_father', ['curp' => $father->curp])}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="paterno" name="paterno"
                                           ...
                                           value="{{ $father->paterno }}" autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="materno" name="materno"
                                           ...
                                           value="{{ $father->materno }}" autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="telephone1" name="telephone1"
                                           ...
                                           value="{{ $father->telephone1 }}" autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="telephone2" name="telephone2"
                                           ...
                                           value="{{ $father->telephone2 }}" autofocus>
